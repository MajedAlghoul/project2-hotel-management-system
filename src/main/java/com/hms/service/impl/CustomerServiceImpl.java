...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerDto modifyCustomer(CustomerDto partialCustomer) {
        Customer originalCustomer = customerRepository.findByEmail(partialCustomer.getEmail()).orElseThrow(() -> new ResourceNotFoundException("Customer", "customer_id", String.valueOf(partialCustomer.getEmail())));
